...
class MeatyBurgerSelectedScreen
    extends GetWidget<MeatyBurgerSelectedController> {
  const MeatyBurgerSelectedScreen({Key? key}) : super(key: key);
                              ...
                              child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                          image:
                                              fs.Svg(ImageConstant.imgGroup148),
                                          fit: BoxFit.cover)),
                                  child: Column(
                                      mainAxisAlignment: MainAxisAlignment.end,
                                      children: [
  ...
  /// Navigates to the meatyBurgerSelectedTwoScreen when the action is triggered.

  /// When the action is triggered, this function uses the `Get` package to
  /// push the named route for the meatyBurgerSelectedTwoScreen.
  onTapTxtIncreasequantit() {
    Get.toNamed(
      AppRoutes.meatyBurgerSelectedTwoScreen,
    );
  }
}
