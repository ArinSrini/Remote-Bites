...
class MeatyBurgerSelectedTwoScreen
    extends GetWidget<MeatyBurgerSelectedTwoController> {
  const MeatyBurgerSelectedTwoScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the meatyBurgerSelectedScreen when the action is triggered.

  /// When the action is triggered, this function uses the `Get` package to
  /// push the named route for the meatyBurgerSelectedScreen.
  onTapTxtDecreasequantit() {
    Get.toNamed(
      AppRoutes.meatyBurgerSelectedScreen,
    );
  }
}
