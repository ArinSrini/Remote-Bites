...
class Beverages1ItemWidget extends StatelessWidget {
  Beverages1ItemWidget(
    this.beverages1ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Beverages1ItemModel beverages1ItemModelObj;
                      ...
                      child: Stack(
                        ...
                        children: [
                          Align(
                            ...
                            child: Container(
                              decoration:
                                  AppDecoration.fillIndigo90001.copyWith(
                                borderRadius: BorderRadiusStyle.roundedBorder15,
                              ),
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
