...
class PizzaSmallTwoScreen extends GetWidget<PizzaSmallTwoController> {
  const PizzaSmallTwoScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the pizzaMediumTwoScreen when the action is triggered.

  /// When the action is triggered, this function uses the `Get` package to
  /// push the named route for the pizzaMediumTwoScreen.
  onTapEllipseeleven() {
    Get.toNamed(
      AppRoutes.pizzaMediumTwoScreen,
    );
  }
