...
class PizzaSmallScreen extends GetWidget<PizzaSmallController> {
  const PizzaSmallScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the pizzaMediumScreen when the action is triggered.

  /// When the action is triggered, this function uses the `Get` package to
  /// push the named route for the pizzaMediumScreen.
  navigatetopizza_medium() {
    Get.toNamed(
      AppRoutes.pizzaMediumScreen,
    );
  }

  /// Navigates to the pizzaBigScreen when the action is triggered.

  /// When the action is triggered, this function uses the `Get` package to
  /// push the named route for the pizzaBigScreen.
  onTapEllipsetwelve() {
    Get.toNamed(
      AppRoutes.pizzaBigScreen,
    );
  }
